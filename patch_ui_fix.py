...
logo=app or '/investiga-mark.webp'; wm=wordmark or '/investiga-wordmark.svg'
...
p.write_text(s,encoding='utf-8');print('Applied approved single-piece INVESTIGA wordmark asset and header order')
