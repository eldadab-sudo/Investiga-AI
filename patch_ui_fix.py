...
a_svg='''<svg viewBox="0 0 23 31" aria-hidden="true" focusable="false"><path d="M0 31 L8.65 0 H14.35 L23 31 H16.55 L11.5 10.4 L6.45 31 Z" fill="#20B9EE"/></svg>'''
...
p.write_text(s,encoding='utf-8');print('INVESTIGA final A: exact 23x31 geometry, full cap height, proportional width, no crossbar, icon cyan')
