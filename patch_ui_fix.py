...
css='''
.app-header{position:sticky;top:0;z-index:60;background:#0b1620;border-bottom:1px solid #253747;padding:15px 12px 17px!important;display:flex!important;justify-content:center!important;align-items:center!important}
.app-brand-stack{width:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;gap:8px}.app-header-logo{display:block;width:68px;height:68px;border-radius:17px;object-fit:cover;box-shadow:0 0 0 1px #31506a,0 8px 22px rgba(0,0,0,.32)}
.wordmark{direction:ltr!important;unicode-bidi:isolate;display:flex;align-items:baseline;justify-content:center;height:38px;margin:0 auto;font-family:Arial,Helvetica,sans-serif;font-size:34px;font-weight:800;letter-spacing:.1px;line-height:38px;color:#fff}.wordmark-text{display:block}.wordmark-a{position:relative;display:block;width:28px;height:34px;margin-left:1px;flex:0 0 28px;align-self:center}.wordmark-a .l,.wordmark-a .r{position:absolute;top:0;width:7px;height:34px;background:#27b9ed;border-radius:.5px}.wordmark-a .l{left:6px;transform:skew(-17deg)}.wordmark-a .r{right:6px;transform:skew(17deg)}
.app-meta{direction:ltr;display:flex;align-items:center;justify-content:center;gap:9px}.app-meta .muted{font-size:13px;color:#9fb0bf;line-height:1.2}.app-meta .tag{margin:0;font-size:12px;padding:4px 9px}.page-brand{display:none!important}.wrap{padding-top:10px!important}#home .hero{text-align:center;padding:18px 0 12px!important;max-width:760px;margin:0 auto}#home .hero>.tag{display:table;margin:0 auto 17px}#home .hero h1{max-width:650px;margin-left:auto;margin-right:auto;line-height:1.2}#home .hero p{max-width:610px;margin-left:auto;margin-right:auto;line-height:1.6}#orgStep>h2{text-align:center;margin:28px auto 21px}
@media(max-width:760px){.app-header{padding:14px 10px 16px!important}.app-header-logo{width:66px;height:66px}.wordmark{font-size:33px;height:37px;line-height:37px}.wordmark-a{width:27px;height:33px;flex-basis:27px}.wordmark-a .l,.wordmark-a .r{height:33px;width:7px}.app-meta .muted{font-size:12.5px}.app-meta .tag{font-size:12px;padding:4px 9px}.wrap{padding-top:8px!important}#home .hero{padding:17px 8px 11px!important}#home .hero>.tag{font-size:12px;max-width:92vw;white-space:normal}#home .hero h1{font-size:clamp(33px,8.7vw,44px)}#home .hero p{font-size:clamp(18px,4.8vw,22px);line-height:1.6}#orgStep>h2{font-size:clamp(25px,6.8vw,33px);margin-top:25px}}
'''
...
p.write_text(s,encoding='utf-8');print('polished header applied')
