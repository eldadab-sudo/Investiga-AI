...
wordmark=uri('web/investiga-wordmark.svg','image/svg+xml') or '/investiga-wordmark.svg'
...
p.write_text(s,encoding='utf-8');print('Applied fixed INVESTIGA wordmark as one SVG asset')
